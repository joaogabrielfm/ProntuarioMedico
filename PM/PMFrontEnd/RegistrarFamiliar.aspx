<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegistrarFamiliar.aspx.cs" Inherits="PMFrontEnd.RegistrarFamiliar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div class="form" style="text-align:center;" >

                <p class="message" style=" font-weight: 600;  font-size: 16px;    padding-top: 10px;    padding-bottom: 20px;">CADASTRO DE FARMILIAR</p>
                    ...
                    <asp:Button ID="btCreate" runat="server" Text="Cadastrar" style="background:#0EBFE9" OnClick="btCreate_Click"/>
          </div>
</asp:Content>
