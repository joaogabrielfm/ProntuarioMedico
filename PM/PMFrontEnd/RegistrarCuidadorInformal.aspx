<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegistrarCuidadorInformal.aspx.cs" Inherits="PMFrontEnd.RegistrarCuidadorInformal" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div class="form" style="text-align:center;" >

                <p class="message" style=" font-weight: 600;  font-size: 16px;    padding-top: 10px;    padding-bottom: 20px;">CADASTRO DE CUIDADOR INFORMAL</p>
